...
public class mysqlUtils1 {
    ...
    //设置url等参数
    static final String DB_URL="jdbc:mysql://localhost:3306/COURSE2?useUnicode=true&characterEncoding=utf8";
    ...
    public ResultSet judge(String sql) throws SQLException {
        ...
        ResultSet resultSet = pStatement.executeQuery(sql);//Resultset就是执行sql语句后返回的结果，已经封装成一个数据表，指针指向第一行
        return resultSet;
    }
